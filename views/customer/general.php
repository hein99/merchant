...
function customersJsonReturn($customers, $activate)
{
  ...
  foreach ($customers as $customer) {
    ...
    $new_customer = (object)array(
      ...
      'activate_status' => $activate ? '<input type="checkbox" class="activate-toggle-js" data-id="'. $customer['id'] .'" checked>' : '<input type="checkbox" class="activate-toggle-js" data-id="'. $customer['id'] .'">'
    );
