    ...
    case 3:
      foreach ($orders as $order) {
        ...
        $new_customer = (object)array(
          ...
          'us_tax' => $order['us_tax'] . '&nbsp;$',
          'shipping_cost' => $order['shipping_cost'] . '&nbsp;$',
          'first_payment_dollar' => '<span class="first-payment-dollar-js" data-fpayment="'.$first_payment_dollar.'">'.number_format($first_payment_dollar, 2).'</span>&nbsp;$',
          'first_exchange_rate' => number_format($order['first_exchange_rate'], 2) . '&nbsp;MMK',
          'first_payment_mmk' => number_format($first_payment_mmk, 2) . '&nbsp;MMK',
          ...
          'second_payment_dollar' => '<span class="second-payment-dollar-js">'.number_format($second_payment_dollar, 2).'</span>&nbsp;$',
